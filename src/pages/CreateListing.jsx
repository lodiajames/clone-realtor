...
export default function CreateListing() {
    ...
    const {type, name, beds, bath, parking, furnished, address, description, offer, regularPrice, discountPrice}=formData
    function onChange(){
    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form>
            ...
            <div className=" flex">
                ...
                <button type='button ml-3' id="type" value="sale" onClick={onChange}
       ...
       <div className="mb-6">
        ...
        transition duration-150 ease-in-out focus:bg-white focus:border-slate-600" type="file" id="images" onChange={onChange} accept=".jpg,.png,jpeg" />
       ...
       active:bg-blue-800 active:shadow-lg transition duration-200 ease-in-out' type='submit'> Create listing</button>
